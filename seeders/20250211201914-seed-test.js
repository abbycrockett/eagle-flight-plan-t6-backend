      ...
      // Eagle Flight Plan
      {
        ...
        // Bridge Tables
        {
          ...
          await queryInterface.bulkInsert('users', [
            ...
            { fName: 'Arrian', lName: 'Taton', email: 'charlie.brown@example.com', phone_number: '222-333-4444', prefix: 'Ms.', studentId: 5, reviewerId: 5, adminId: 5, createdAt: new Date(), updatedAt: new Date() },
        ...
        //Bridge Tables *
        {
          ...
          await queryInterface.bulkInsert('studentFlightPlanTasks', [
            { studentFlightPlanId: 1, taskId: 1, userId: 1, points_earned: 10, completed_date: new Date('2025-01-15'), unapprove_reason: null, status: 'approved', createdAt: new Date(), updatedAt: new Date() },
            { studentFlightPlanId: 2, taskId: 2, userId: 2, points_earned: 8, completed_date: new Date('2025-02-01'), unapprove_reason: null, status: 'ready_for_review', createdAt: new Date(), updatedAt: new Date() },
            { studentFlightPlanId: 3, taskId: 3, userId: 3, points_earned: 12, completed_date: new Date('2025-01-20'), unapprove_reason: 'Did not meet minimum criteria.', status: 'unapproved', createdAt: new Date(), updatedAt: new Date() },
            { studentFlightPlanId: 4, taskId: 4, userId: 4, points_earned: 15, completed_date: new Date('2025-01-22'), unapprove_reason: null, status: 'approved', createdAt: new Date(), updatedAt: new Date() },
            { studentFlightPlanId: 5, taskId: 5, userId: 5, points_earned: 5, completed_date: new Date('2025-02-10'), unapprove_reason: null, status: 'in_progress', createdAt: new Date(), updatedAt: new Date() },
            { studentFlightPlanId: 6, taskId: 6, userId: 6, points_earned: 10, completed_date: new Date('2025-01-18'), unapprove_reason: null, status: 'approved', createdAt: new Date(), updatedAt: new Date() },
            { studentFlightPlanId: 7, taskId: 7, userId: 7, points_earned: 9, completed_date: new Date('2025-02-05'), unapprove_reason: null, status: 'ready_for_review', createdAt: new Date(), updatedAt: new Date() },
            { studentFlightPlanId: 8, taskId: 8, userId: 8, points_earned: 11, completed_date: new Date('2025-01-25'), unapprove_reason: null, status: 'approved', createdAt: new Date(), updatedAt: new Date() },
            { studentFlightPlanId: 9, taskId: 9, userId: 9, points_earned: 14, completed_date: new Date('2025-01-30'), unapprove_reason: 'Failed to meet deadline.', status: 'unapproved', createdAt: new Date(), updatedAt: new Date() },
            { studentFlightPlanId: 10, taskId: 10, userId: 10, points_earned: 6, completed_date: new Date('2025-02-08'), unapprove_reason: null, status: 'in_progress', createdAt: new Date(), updatedAt: new Date() }
          ]);
