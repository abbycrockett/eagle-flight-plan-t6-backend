      ...
      // Eagle Flight Plan
      {
        ...
        //Bridge Tables *
        {
          ...
          await queryInterface.bulkInsert("studentFlightPlanTasks", [
            ...
            {
              points_earned: 0,
              completed_date: new Date(Date.now() - 9 * 24 * 60 * 60 * 1000),
              unapprove_reason: null,
              status: "approved",
              reflection: null,
            ...
            },
            {
              ...
              updatedAt: new Date(Date.now() - 37 * 24 * 60 * 60 * 1000),
              studentFlightPlanId: 32,
              taskId: 2,
            },
            {
            ...
            },
            {
              ...
              updatedAt: new Date(Date.now() - 68 * 24 * 60 * 60 * 1000),
              studentFlightPlanId: 32,
              taskId: 3,
            },
            {
          ...
          await queryInterface.bulkInsert("studentEvents", [
            ...
            // 3 students interested in event 21
            {
              studentId: 1,
              eventId: 21,
              attendance_status: "attended",
