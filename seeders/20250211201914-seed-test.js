    ...
    // Populate Tables
    {
      ...
      // Eagle Flight Plan
      {
        ...
        // Bridge Tables
        {
          ...
          await queryInterface.bulkInsert('events', [
            { name: 'Public Speaking Workshop', description: 'Enhance your presentation skills', event_type: 'career_services', date: new Date('2025-04-02'), start_date_time: new Date('2025-04-02T09:00:00'), end_date_time: new Date('2025-04-02T11:00:00'), location: 'Room 150', attendance_type: 'in_person', registration: 'handshake', custom: false, status: 'scheduled', point_value: 10, verificationId: 16, createdAt: new Date(), updatedAt: new Date() },
            { name: 'Art Therapy Session', description: 'De-stress through creative expression', event_type: 'extra_curricular', date: new Date('2025-04-03'), start_date_time: new Date('2025-04-03T10:00:00'), end_date_time: new Date('2025-04-03T11:30:00'), location: 'Wellness Center', attendance_type: 'in_person', registration: 'in_app', custom: false, status: 'scheduled', point_value: 8, verificationId: 17, createdAt: new Date(), updatedAt: new Date() },
            { name: 'Business Networking Social', description: 'Meet professionals in finance & marketing', event_type: 'mentoring', date: new Date('2025-04-04'), start_date_time: new Date('2025-04-04T13:00:00'), end_date_time: new Date('2025-04-04T15:00:00'), location: 'Downtown Café', attendance_type: 'in_person', registration: 'handshake', custom: false, status: 'scheduled', point_value: 12, verificationId: 18, createdAt: new Date(), updatedAt: new Date() },
            { name: 'Environmental Sustainability Panel', description: 'Discuss climate change solutions', event_type: 'career_services', date: new Date('2025-04-05'), start_date_time: new Date('2025-04-05T08:00:00'), end_date_time: new Date('2025-04-05T11:00:00'), location: 'Lecture Hall A', attendance_type: 'online', registration: 'in_app', custom: false, status: 'scheduled', point_value: 15, verificationId: 19, createdAt: new Date(), updatedAt: new Date() },
            { name: 'Music Appreciation Night', description: 'Explore different music genres', event_type: 'extra_curricular', date: new Date('2025-04-06'), start_date_time: new Date('2025-04-06T14:00:00'), end_date_time: new Date('2025-04-06T16:30:00'), location: 'Campus Auditorium', attendance_type: 'in_person', registration: 'in_app', custom: false, status: 'scheduled', point_value: 10, verificationId: 20, createdAt: new Date(), updatedAt: new Date() }
          ]);
          
          await queryInterface.bulkInsert('events', [
            { name: 'Cybersecurity Panel', description: 'Discuss latest cybersecurity trends', event_type: 'career_services', date: new Date('2025-04-02'), start_date_time: new Date('2025-04-02T08:00:00'), end_date_time: new Date('2025-04-02T10:00:00'), location: 'Auditorium', attendance_type: 'online', registration: 'in_app', custom: false, status: 'scheduled', point_value: 12, verificationId: 11, createdAt: new Date(), updatedAt: new Date() },
            { name: 'Cloud Computing Workshop', description: 'Learn about AWS, Azure, and GCP', event_type: 'career_services', date: new Date('2025-04-03'), start_date_time: new Date('2025-04-03T11:00:00'), end_date_time: new Date('2025-04-03T14:00:00'), location: 'Room 204', attendance_type: 'in_person', registration: 'handshake', custom: false, status: 'scheduled', point_value: 15, verificationId: 12, createdAt: new Date(), updatedAt: new Date() },
            { name: 'Game Development Jam', description: 'Create a game in 24 hours', event_type: 'extra_curricular', date: new Date('2025-04-04'), start_date_time: new Date('2025-04-04T12:00:00'), end_date_time: new Date('2025-04-05T12:00:00'), location: 'Lab 303', attendance_type: 'in_person', registration: 'in_app', custom: false, status: 'scheduled', point_value: 25, verificationId: 13, createdAt: new Date(), updatedAt: new Date() },
            { name: 'Soft Skills Training', description: 'Enhance communication & teamwork', event_type: 'career_services', date: new Date('2025-04-05'), start_date_time: new Date('2025-04-05T09:00:00'), end_date_time: new Date('2025-04-05T12:00:00'), location: 'Career Center', attendance_type: 'online', registration: 'handshake', custom: false, status: 'scheduled', point_value: 10, verificationId: 14, createdAt: new Date(), updatedAt: new Date() },
            { name: 'Hackathon Bootcamp', description: 'Prep for an upcoming hackathon', event_type: 'extra_curricular', date: new Date('2025-04-06'), start_date_time: new Date('2025-04-06T10:00:00'), end_date_time: new Date('2025-04-06T15:00:00'), location: 'Innovation Lab', attendance_type: 'in_person', registration: 'in_app', custom: false, status: 'scheduled', point_value: 18, verificationId: 15, createdAt: new Date(), updatedAt: new Date() }
          ]);
